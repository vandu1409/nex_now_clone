...
var t2 = { color: "{text.muted.color}", hoverColor: "{text.color}", activeColor: "{text.color}", padding: "1.125rem", fontWeight: "600", borderRadius: "0", borderWidth: "0", borderColor: "{content.border.color}", background: "{content.background}", hoverBackground: "{content.background}", activeBackground: "{content.background}", activeHoverBackground: "{content.background}", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "-1px", shadow: "{focus.ring.shadow}" }, toggleIcon: { color: "{text.muted.color}", hoverColor: "{text.color}", activeColor: "{text.color}", activeHoverColor: "{text.color}" }, first: { topBorderRadius: "{content.border.radius}", borderWidth: "0" }, last: { bottomBorderRadius: "{content.border.radius}", activeBottomBorderRadius: "0" } };
...
var d3 = { root: o8, body: r8, caption: t4, title: e7, subtitle: a3 };
...
var i3 = { width: "2rem", height: "0.5rem", borderRadius: "{content.border.radius}", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" } };
...
var t5 = { root: r9, content: o9, indicatorList: a4, indicator: i3, colorScheme: c4 };
...
var i4 = { color: "{form.field.icon.color}" };
var f2 = { root: o10, dropdown: r10, overlay: d4, list: l2, option: e8, clearIcon: i4 };
...
var i5 = { light: { root: { background: "{surface.100}", color: "{surface.800}" }, icon: { color: "{surface.800}" }, removeIcon: { color: "{surface.800}" } }, dark: { root: { background: "{surface.800}", color: "{surface.0}" }, icon: { color: "{surface.0}" }, removeIcon: { color: "{surface.0}" } } };
var s2 = { root: o12, image: r12, icon: e10, removeIcon: c5, colorScheme: i5 };
...
var a6 = { root: o15, content: r15, icon: e13, footer: p };
...
var i6 = { padding: "{navigation.list.padding}", gap: "{navigation.list.gap}" };
...
var c6 = { root: o16, list: i6, item: n3, submenu: a7, submenuIcon: t6, separator: r16 };
...
var k = { root: o17, header: r17, headerCell: e14, columnTitle: d5, row: t7, bodyCell: l3, footerCell: c7, columnFooter: n4, footer: a8, dropPoint: i7, columnResizer: s4, resizeIndicator: g, sortIcon: u, loadingIcon: b, rowToggleButton: p2, filter: m, paginatorTop: h, paginatorBottom: f3, colorScheme: v };
...
var c8 = { root: o18, header: r18, content: d6, footer: e15, paginatorTop: t8, paginatorBottom: n5 };
...
var i8 = { borderColor: "{content.border.color}", gap: "{overlay.popover.padding}" };
...
var k2 = { root: o19, panel: r19, header: e16, title: c9, dropdown: d7, inputIcon: n6, selectMonth: t9, selectYear: a9, group: i8, dayView: l4, weekDay: u2, date: s5, monthView: g2, month: f4, yearView: h2, year: b2, buttonbar: m2, timePicker: p3, colorScheme: v2 };
...
var e17 = { root: o20, header: a10, title: d8, content: r20, footer: l5 };
...
var t10 = { root: r21, content: o21, horizontal: n7, vertical: e18 };
...
var e19 = { root: o23, header: a11, title: d10, content: r23, footer: l6 };
...
var l7 = { toolbar: o24, toolbarItem: r24, overlay: e20, overlayOption: t11, content: d11 };
...
var n8 = { padding: "0" };
var e21 = { root: o25, legend: r25, toggleIcon: t12, content: n8 };
...
var d12 = { gap: "0.5rem" };
var i9 = { root: r26, header: o26, content: e22, file: t13, fileList: a12, progressbar: n9, basic: d12 };
...
var d13 = { root: o27, over: i10, in: r27, on: a13 };
...
var i11 = { background: "rgba(0, 0, 0, 0.5)" };
...
var l8 = { root: o28, navButton: r28, navIcon: e23, thumbnailsContent: t14, thumbnailNavButton: c10, thumbnailNavButtonIcon: n10, caption: a14, indicatorList: s6, indicatorButton: u3, insetIndicatorList: i11, insetIndicatorButton: d14, closeButton: g3, closeButtonIcon: f5, colorScheme: h3 };
...
var i13 = { hoverBackground: "rgba(255,255,255,0.1)", color: "{surface.50}", hoverColor: "{surface.0}", size: "3rem", iconSize: "1.5rem", borderRadius: "50%", focusRing: { width: "{focus.ring.width}", style: "{focus.ring.style}", color: "{focus.ring.color}", offset: "{focus.ring.offset}", shadow: "{focus.ring.shadow}" } };
var e24 = { root: o31, preview: r30, toolbar: a15, action: i13 };
...
var a16 = { root: r32, text: o33, icon: e25, colorScheme: n11 };
...
var c11 = { root: o39, value: r38, range: t16, text: n13 };
...
var i14 = { background: "{list.option.group.background}", color: "{list.option.group.color}", fontWeight: "{list.option.group.font.weight}", padding: "{list.option.group.padding}" };
...
var n14 = { root: o40, list: r39, option: d17, optionGroup: i14, checkmark: t17, emptyMessage: e28, colorScheme: l10 };
...
var i15 = { focusBackground: "{navigation.item.focus.background}", activeBackground: "{navigation.item.active.background}", color: "{navigation.item.color}", focusColor: "{navigation.item.focus.color}", activeColor: "{navigation.item.active.color}", padding: "{navigation.item.padding}", borderRadius: "{navigation.item.border.radius}", gap: "{navigation.item.gap}", icon: { color: "{navigation.item.icon.color}", focusColor: "{navigation.item.icon.focus.color}", activeColor: "{navigation.item.icon.active.color}" } };
...
var g4 = { root: o41, baseItem: n15, item: i15, overlay: a18, submenu: r40, submenuLabel: t18, submenuIcon: e29, separator: c12, mobileButton: d18 };
...
var i16 = { padding: "{navigation.submenu.label.padding}", fontWeight: "{navigation.submenu.label.font.weight}", background: "{navigation.submenu.label.background}", color: "{navigation.submenu.label.color}" };
var t19 = { borderColor: "{content.border.color}" };
var r41 = { root: o42, list: n16, item: a19, submenuLabel: i16, separator: t19 };
...
var i17 = { borderRadius: "{content.border.radius}", padding: "{navigation.item.padding}" };
...
var e30 = { root: o43, baseItem: i17, item: n17, submenu: r42, separator: a20, mobileButton: t20 };
...
var u4 = { root: o44, content: r43, text: e31, icon: n18, closeButton: l11, closeIcon: s7, outlined: c13, simple: a21, colorScheme: d19 };
...
var b3 = { root: e32, meters: r44, label: a22, labelMarker: o45, labelIcon: l12, labelList: t21 };
...
var i18 = { focusBackground: "{list.option.focus.background}", selectedBackground: "{list.option.selected.background}", selectedFocusBackground: "{list.option.selected.focus.background}", color: "{list.option.color}", focusColor: "{list.option.focus.color}", selectedColor: "{list.option.selected.color}", selectedFocusColor: "{list.option.selected.focus.color}", padding: "{list.option.padding}", borderRadius: "{list.option.border.radius}", gap: "0.5rem" };
...
var n19 = { root: o46, dropdown: d20, overlay: r45, list: l13, option: i18, optionGroup: e33, chip: a23, clearIcon: f7, emptyMessage: c14 };
...
var n20 = { root: o48, node: r47, nodeToggleButton: e34, connector: t22 };
...
var n21 = { root: o50, navButton: r48, currentPageReport: t24, jumpToPageInput: e35 };
...
var a25 = { root: r49, header: o51, toggleableHeader: e36, title: d21, content: t25, footer: n22 };
...
var a26 = { root: o52, panel: r50, item: n23, submenu: i19, submenuIcon: t26 };
...
var n24 = { meter: r51, icon: o53, overlay: e37, content: a27, colorScheme: d22 };
...
var t27 = { root: r54, value: o56, label: e39 };
...
var n25 = { root: o62, dropdown: r60, overlay: d23, list: l14, option: i21, optionGroup: e41, clearIcon: f8, checkmark: c15, emptyMessage: a30 };
...
var a32 = { root: o65, track: r63, range: n26, handle: t28, colorScheme: e42 };
...
var t30 = { root: o66, gutter: r65, handle: n27 };
...
var i22 = { root: o67, separator: r66, step: e43, stepHeader: t31, stepTitle: n28, stepNumber: a34, steppanels: c16, steppanel: d26 };
...
var c17 = { root: o68, separator: r67, itemLink: t32, itemLabel: e44, itemNumber: n29 };
...
var n30 = { root: o69, tablist: r68, item: t33, itemIcon: e45, activeBar: c18 };
...
var i23 = { root: o70, tablist: r69, tab: t34, tabpanel: n31, navButton: c19, activeBar: e46, colorScheme: a35 };
...
var e47 = { root: o71, tabList: r70, tab: t35, tabPanel: n32, navButton: a36, colorScheme: c20 };
...
var e48 = { root: r72, prompt: o73, commandResponse: d27 };
...
var i24 = { padding: "{navigation.list.padding}", gap: "{navigation.list.gap}" };
...
var c21 = { root: o75, list: i24, item: n34, submenu: a38, submenuIcon: t36, separator: r73 };
...
var d29 = { event: e49, horizontal: r74, vertical: o76, eventMarker: n35, eventConnector: t37 };
...
var u5 = { root: o77, icon: r75, content: e50, text: n36, summary: a39, detail: s9, closeButton: c22, closeIcon: l15, colorScheme: t38 };
...
var c23 = { root: r76, icon: o78, content: e51, colorScheme: d30 };
...
var c24 = { root: r77, handle: o79, colorScheme: e52 };
...
var e53 = { root: r79, colorScheme: o81 };
...
var d31 = { root: o82, node: r80, nodeIcon: e54, nodeToggleButton: t39, loadingIcon: c25, filter: n37 };
...
var i25 = { borderRadius: "{border.radius.sm}" };
var f9 = { color: "{form.field.icon.color}" };
var a40 = { root: o83, dropdown: r81, overlay: d32, tree: l16, emptyMessage: e55, chip: i25, clearIcon: f9 };
...
var i26 = { background: "{content.background}", borderColor: "{treetable.border.color}", color: "{content.color}", borderWidth: "0 0 1px 0", padding: "0.75rem 1rem" };
...
var k3 = { root: o84, header: r82, headerCell: e56, columnTitle: t40, row: c26, bodyCell: n38, footerCell: d33, columnFooter: l17, footer: i26, columnResizer: a41, resizeIndicator: g5, sortIcon: s10, loadingIcon: u6, nodeToggleButton: h4, paginatorTop: b4, paginatorBottom: f10, colorScheme: m3 };
...
var i27 = Object.getOwnPropertySymbols;
var t41 = Object.prototype.hasOwnProperty;
var a42 = Object.prototype.propertyIsEnumerable;
var o86 = (e59, m5, i28) => m5 in e59 ? r83(e59, m5, { enumerable: true, configurable: true, writable: true, value: i28 }) : e59[m5] = i28;
var Nr;
var Qr = (Nr = ((r84, e59) => {
  for (var m5 in e59 || (e59 = {})) t41.call(e59, m5) && o86(r84, m5, e59[m5]);
  if (i27) for (var m5 of i27(e59)) a42.call(e59, m5) && o86(r84, m5, e59[m5]);
  return r84;
})({}, e5), e58(Nr, m4({ components: { accordion: c, autocomplete: a, avatar: n, badge: d2, blockui: o6, breadcrumb: t, button: e6, card: d3, carousel: t5, cascadeselect: f2, checkbox: e9, chip: s2, colorpicker: s3, confirmdialog: r14, confirmpopup: a6, contextmenu: c6, datatable: k, dataview: c8, datepicker: k2, dialog: e17, divider: t10, dock: d9, drawer: e19, editor: l7, fieldset: e21, fileupload: i9, floatlabel: d13, galleria: l8, iconfield: r29, iftalabel: i12, image: e24, imagecompare: r31, inlinemessage: a16, inplace: n12, inputchips: f6, inputgroup: o36, inputnumber: a17, inputotp: e27, inputtext: d16, knob: c11, listbox: n14, megamenu: g4, menu: r41, menubar: e30, message: u4, metergroup: b3, multiselect: n19, orderlist: o47, organizationchart: n20, overlaybadge: t23, paginator: n21, panel: a25, panelmenu: a26, password: n24, picklist: o54, popover: e38, progressbar: t27, progressspinner: r55, radiobutton: e40, rating: i20, ripple: o60, scrollpanel: a29, select: n25, selectbutton: d24, skeleton: o64, slider: a32, speeddial: a33, splitbutton: d25, splitter: t30, stepper: i22, steps: c17, tabmenu: n30, tabs: i23, tabview: e47, tag: n33, terminal: e48, textarea: d28, tieredmenu: c21, timeline: d29, toast: u5, togglebutton: c23, toggleswitch: c24, toolbar: r78, tooltip: e53, tree: d31, treeselect: a40, treetable: k3, virtualscroller: e57 } })));
export {
  Qr as default
};
