<template>
    <div class="h-screen flex">
        <div class="w-full md:w-1/2 px-4 flex justify-center items-center relative ">
            ...
            <div class="flex items-center justify-center min-h-screen mx-auto">
                <div class="text-center space-y-2">
                  ...
                  <div class="w-full flex justify-center mt-5">
                      <h1 class="text-2xl font-bold text-center w-[400px] text-[#403D50]">Hàng ngàn địa điểm đang đợi bạn trải nghiệm</h1>
                  </div>
                    <div class="space-y-3 mt-5">
                        <button @click="loginWithGoogle"
                            class="rounded-3xl px-6 py-3 w-full flex items-center justify-center space-x-3 border hover:bg-[#F9F1FF] hover:text-[#812D9E] transition">
                        ...
                        <div class="text-base">
                            <span>Chưa có tài khoản? <router-link to="/register" class="text-[#5f1f76]">Đăng ký</router-link></span>
                        </div>

                        <div>
                            Bằng cách đăng nhập, bạn đồng ý với chúng tôi <router-link class="text-[#5f1f76]">Điều khoản
                                dịch vụ</router-link> và <router-link class="text-[#5f1f76]">Chính sách quyền riêng
                                tư</router-link>
                        </div>
...
const loginWithGoogle = () => {
  isHandled = false; 
  window.open(
    'http://localhost:8000/api/auth/redirect/google',
    'googleLogin',
